 ...
 */
    ...
    *****************************************************************************/
    public abstract class PicFoodUI
    {
        ...
        *   {@link PicFoodGridViewContentLoading}.
        *
        ...
        *****************************************************************************/
        public static void pruneLoadingItems( Vector<LibAdapterData> adapterData )
        {
            for ( int i = adapterData.size() - 1; i >= 0; --i )
            {
                ...
                if ( adapterData.elementAt( i ) instanceof PicFoodGridViewContentLoading )
                {
                    //prune it!
            ...
            if ( imageView != null && newImage != null )
            {
                ...
                if ( Features.ENABLE_IMAGE_ALPHA_ANIMATIONS )
                {
                    ...
                    (
                        ...
                        newImage,
                        PicFoodSettings.Performance.TRANSITION_ITEMS_FADING_MILLIS
                    );
                }
                else
                {
