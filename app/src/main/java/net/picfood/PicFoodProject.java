        ...
        *****************************************************************************************/
        ...
        public static final class Debug
        {
            ...
            *****************************************************************************************/
            ...
            {
                /** Simulate a response for the 'getImageLike' json rpc request. {@link net.picfood.io.jsonrpc.PicFoodJsonRPCImage#getImageLikes(android.app.Activity, String, int)} */
                public  static  final   boolean             SIMULATE_GET_IMAGE_LIKES                            = ( false   && Debug.DEBUG_MODE );
                /** Simulate a response for the 'getImageFoodRatings' json rpc request. {@link net.picfood.io.jsonrpc.PicFoodJsonRPCImage#getFoodRatings(android.app.Activity, String, int)} */
