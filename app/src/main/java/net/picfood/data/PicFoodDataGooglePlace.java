/*  $Id: PicFoodDataGooglePlace.java 50587 2013-08-14 09:04:26Z schristopher $
 *  ==============================================================================================================
 */
    ...
    *   @see        "$URL: http://svn.synapsy.net/svn/Synapsy/PicFood/android/PicFood_1_0/trunk/src/net/picfood/data/PicFoodDataGooglePlace.java $"
    *****************************************************************************/
    public class PicFoodDataGooglePlace implements Serializable, PicFoodData
    {
        /************************************************************************
        ...
        **********************************************************************************************/
        public PicFoodDataGooglePlace( JSONObject json, Location srcLocation )
        {
        ...
        *****************************************************************************/
        public static final Vector<PicFoodDataGooglePlace> parse( String jsonBody, Location srcLocation )
        {
            PicFoodDebug.googlePlacesParser.out( "Parsing .." );

            //prepare results
            Vector<PicFoodDataGooglePlace> ret = new Vector<PicFoodDataGooglePlace>();
            ...
            try
            {
                ...
                PicFoodDebug.googlePlacesParser.out( "Results count: [" + arr.length() + "]" );
                ...
                for ( int i = 0; i < arr.length(); ++ i )
                {
                    ...
                    PicFoodDebug.googlePlacesParser.out( "Entry # [" + i + "]: [" + entry + "]" );

                    //assign to return array
                    ret.addElement
                    (
                        new PicFoodDataGooglePlace( entry, srcLocation )
                    );
                }
            }
            catch ( Throwable t )
            {
                PicFoodDebug.googlePlacesParser.out( "Parsing GooglePlaces-Results raised an Exception:" );
        ...
        *****************************************************************************/
        ...
        public void assignLoadedImage( LibState state, ImageSize imageSize, BitmapDrawable bd )
        {
            ...
            //update ImageView
            PicFoodUI.setNewImageUIThreaded( state.getActivity(), bd, iIconView, R.drawable.net_picfood_loading_image );
        }
        ...
        public View createItemView( final LibState state )
        {
            ...
            //title
            {
                ...
                LibUI.setupTextView( title, PicFoodSystems.getFonts().TYPEFACE_BOLD, iName );
            }
            ...
            //description
            {
                ...
                else
                {
                    ...
                    LibUI.setupTextView( description, PicFoodSystems.getFonts().TYPEFACE_REGULAR, text );
                }
            }
            ...
            if ( iIconDrawable == null )
            {
                iIconView.setImageResource( R.drawable.net_picfood_loading_icon_place );
            }
            else
            {
                PicFoodUI.setNewImage( state.getActivity(), iIconDrawable, iIconView, R.drawable.net_picfood_loading_icon_place );
