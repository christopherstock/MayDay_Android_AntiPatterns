    ...
    *   @version    1.0
    **********************************************************************************************/
    public class AntiPatternsDataRating implements AntiPatternsData
    {
        ...
        **********************************************************************************************/
        public AntiPatternsDataRating(JSONObject json)
        {
        ...
        **********************************************************************************************/
        public static final AntiPatternsDataRating[] parse( JSONObject json )
        {
            JSONObject obj = LibJSON.getJSONObjectSecure( json, "foodRatings" );
            JSONArray  arr = LibJSON.getJSONArraySecure(  obj,  "ratings"     );

            AntiPatternsDataRating[] ret = new AntiPatternsDataRating[ arr.length() ];

            for ( int i = 0; i < arr.length(); ++i )
            {
                ret[ i ] = new AntiPatternsDataRating( LibJSON.getJSONObjectSecure( arr, i ) );
            }
        ...
        public View createItemView( final LibState state )
        {
            ...
            LibUI.setupTextView( description, AntiPatternsSystems.getFonts().TYPEFACE_REGULAR, String.valueOf( iVote ) );
            ...
            {
                iOwner.iIconView.setImageResource( R.drawable.de_mayflower_antipattern_loading_icon_user);
            }
            else
            {
                AntiPatternsUI.setNewImage(state.getActivity(), iOwner.iIconDrawable, iOwner.iIconView, R.drawable.de_mayflower_antipattern_loading_icon_user);
