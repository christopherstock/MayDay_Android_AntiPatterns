    ...
    *   @version    1.0
    **********************************************************************************************/
    public class AntiPatternsDataImage implements AntiPatternsData
    {
        /**********************************************************************************************
        ...
        **********************************************************************************************/
        ...
        private                 AntiPatternsDataLike[]                   iInitialLikes                       = new AntiPatternsDataLike[] {};
        /** All comments to show below the image in the detailed representation. */
        private                 AntiPatternsDataComment[]                iInitialComments                    = new AntiPatternsDataComment[] {};
        /** All food ratings to show below the image in the detailed representation. */
        private                 AntiPatternsDataRating[]                 iInitialFoodRatings                 = new AntiPatternsDataRating[] {};
        /** The associated location where this image has been taken. */
        private AntiPatternsDataLocation iLocation                           = null;
        ...
        **********************************************************************************************/
        public AntiPatternsDataImage(JSONObject json, ContentImageStyle aStyle, boolean aLinkUsername)
        {
            ...
            AntiPatternsDebug.dataImage.out( "createDate         [" + iCreateDate + "][" + LibStringFormat.getSingleton().formatDateTimeMedium( iCreateDate )    + "]"                       );
            AntiPatternsDebug.dataImage.out( "owner              [" + iOwner.iUserName                                                                           + "]"                       );
            AntiPatternsDebug.dataImage.out( "location           [" + ( iLocation != null ? iLocation.iLatitude + "," + iLocation.iLongitude : "" )              + "]"                       );
            AntiPatternsDebug.dataImage.out( "comments           [" + iInitialComments.length                                                                    + "] comments"              );
            AntiPatternsDebug.dataImage.out( "imageLikes         [" + iInitialLikes.length                                                                       + "] likes"                 );
            AntiPatternsDebug.dataImage.out( "foodRatings        [" + iInitialFoodRatings.length                                                                 + "] food-ratings"          );
            AntiPatternsDebug.dataImage.out( "averageFoodRating  [" + iAverageFoodRating                                                                         + "] average food rating"   );
            AntiPatternsDebug.dataImage.out( ""                                                                                                                                              );
        }
        ...
        **********************************************************************************************/
        public AntiPatternsDataImage(AntiPatternsDataImage template)
        {
        ...
        **********************************************************************************************/
        public static final AntiPatternsDataImage[] parse( JSONObject response, ContentImageStyle style, boolean linkUsername ) throws Throwable
        {
            JSONArray               images      = LibJSON.getJSONArraySecure( response, "images" );
            AntiPatternsDataImage[]      ret         = new AntiPatternsDataImage[ images.length() ];
            for ( int i = 0; i < images.length(); ++i )
            {
                //parse image from json
                JSONObject image = images.getJSONObject( i );
                ret[ i ] = new AntiPatternsDataImage( image, style, linkUsername );
            }
        ...
        **********************************************************************************************/
        private final View createTiledView( final LibState state )
        {
            ...
            iImageViewContainer.getLayoutParams().width  = AntiPatternsImage.getImageSizeToOrder(state.getActivity(), ImageSize.ETiledImage);
            iImageViewContainer.getLayoutParams().height = AntiPatternsImage.getImageSizeToOrder(state.getActivity(), ImageSize.ETiledImage);
                ...
                (
                    ...
                    new Runnable()
                    {
                        ...
                        public void run()
                        {
                            ...
                            AntiPatternsFlowImage.lastState  = state;
                            AntiPatternsFlowImage.lastImage  = AntiPatternsDataImage.this;

                            //show the selected image in state 'detailed image'
                            AntiPatternsActionState.EEnterDetailedImage.run();
                        }
                    }
                );
            }
...
*/
        ...
        **********************************************************************************************/
        private final void setupDate( View ret, Activity activity )
        {
            ...
            String   dateTime = AntiPatternsUI.formatTimeDistance(activity, iCreateDate);
            LibUI.setupTextView( date, AntiPatternsSystems.getFonts().TYPEFACE_REGULAR, dateTime );
        }
        ...
        **********************************************************************************************/
        private final void setupUserIcon( View ret, Activity activity )
        {
            ...
            else
            {
                ...
                AntiPatternsUI.setNewImage(activity, iIconDrawable, iIconView, R.drawable.de_mayflower_antipattern_loading_icon_user);
        ...
        **********************************************************************************************/
        private final void setupImage( View ret, final LibState state, boolean enableLongpress )
        {
            ...
            {
                iImageView.setImageResource( R.drawable.de_mayflower_antipattern_loading_image);
            }
            else
            {
                //transit from loading-icon to new image
                AntiPatternsUI.setNewImage(state.getActivity(), iImageDrawable, iImageView, R.drawable.de_mayflower_antipattern_loading_image);
                ...
                (
                    ...
                    new Runnable()
                    {
                        ...
                        public void run()
                        {
                            ...
                            AntiPatternsActionPush.EPushImageOptions.run();
                        }
                    }
                );
            }
        ...
        **********************************************************************************************/
        private final void setupImageContainerDetailed( View ret, Activity activity )
        {
            ...
            iImageViewContainer.getLayoutParams().width  = AntiPatternsImage.getDisplayedDetailedImageSize(activity);
            iImageViewContainer.getLayoutParams().height = AntiPatternsImage.getDisplayedDetailedImageSize(activity);
        }
            ...
            (
                ...
                new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        AntiPatternsActionPush.EPushImageLikeUnlike.run();
                    }
                }
            );
        }
            ...
            (
                ...
                new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        //like or unlike the image
                        AntiPatternsActionPush.EPushImageComment.run();
                    }
                }
            );
        }
            ...
            (
                ...
                new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        AntiPatternsActionPush.EPushImageRateFood.run();
                    }
                }
            );

            //show button 'rate' only if the user has not rated this image AND he's the owner
            boolean showRateButton = ( !iIRatedFood && AntiPatternsIDM.getUserID(state.getActivity()).equals( iOwner.iUserID ) );
        ...
        **********************************************************************************************/
        private final void setupTextYouLike( View ret, Activity activity )
        {
            ...
            LibUI.setupTextView( activity, youLike, AntiPatternsSystems.getFonts().TYPEFACE_BOLD, R.string.image_you_like );
        ...
        **********************************************************************************************/
        private final void setupTextAverageFoodRating( View ret, Activity activity )
        {
            ...
            if ( iCountFoodRatings == 0 )
            {
                ...
                LibUI.setupTextView( averageFoodRatingText, AntiPatternsSystems.getFonts().TYPEFACE_BOLD, text );
            ...
            else
            {
                ...
                {
                    averageFoodRatingIcon.setImageResource( R.drawable.de_mayflower_antipattern_rating_small_red);
                }
                else if ( iAverageFoodRating < Image.BOUND_SMILEY_GREEN )
                {
                    averageFoodRatingIcon.setImageResource( R.drawable.de_mayflower_antipattern_rating_small_yellow);
                }
                else
                {
                    averageFoodRatingIcon.setImageResource( R.drawable.de_mayflower_antipattern_rating_small_green);
                }
            }
        }
        ...
        **********************************************************************************************/
        private final void setupTextLikeCount( View ret, final LibState state )
        {
            ...
            if ( iCountLikes == 0 )
            {
                ...
                LibUI.setupTextView( likeCount, AntiPatternsSystems.getFonts().TYPEFACE_BOLD, likeCaption );
            }
        ...
        **********************************************************************************************/
        private final void setupTextCommentCount( View ret, final LibState state )
        {
            ...
            if ( iCountComments == 0 )
            {
                ...
                LibUI.setupTextView( commentCount, AntiPatternsSystems.getFonts().TYPEFACE_BOLD, commentCaption );
            }
        ...
        **********************************************************************************************/
        private final void setupTextRatingCount( View ret, final LibState state )
        {
            ...
            AntiPatternsDebug.ratingsPreviews.out( "CountFoodRatings [" + iCountFoodRatings + "]" );

            if ( iCountFoodRatings == 0 )
            {
                String  ratingCaption = LibResource.getResourceString( state.getActivity(), R.string.image_count_food_ratings_none );

                LibUI.setupTextView( ratingCount, AntiPatternsSystems.getFonts().TYPEFACE_BOLD, ratingCaption );
            }
                    ...
                    (
                        ...
                        new Runnable()
                        {
                            ...
                            public void run()
                            {
                                ...
                                AntiPatternsActionPush.EPushImageShowFoodRatings.run();
                            }
                        }
                    );
                }
        ...
        **********************************************************************************************/
        private final void setupAreaCommentsPreview( View ret, final LibState state )
        {
            ...
            AntiPatternsDebug.commentsPreviews.out( "commentsCount is [" + iCountComments + "]" );
            ...
            {
                //setup label
                LibUI.setupTextView( state.getActivity(), commentsPreviewLabel, AntiPatternsSystems.getFonts().TYPEFACE_BOLD, R.string.image_comments );

                //browse initial comments
                for ( AntiPatternsDataComment comment : iInitialComments )
                {
                    AntiPatternsDebug.commentsPreviews.out( " comment [" + comment.iPostedAt + "][" + comment.iOwner.iUserName + "][" + comment.iText + "]" );
                    ...
                    LibUI.setupTextView( timestampText, AntiPatternsSystems.getFonts().TYPEFACE_REGULAR, AntiPatternsUI.formatTimeDistance(state.getActivity(), comment.iPostedAt) );

                    //comment
                    TextView commentText = (TextView)commentLayoutBody.findViewById( R.id.comment );
                    LibUI.setupTextView( commentText, AntiPatternsSystems.getFonts().TYPEFACE_REGULAR, comment.iText );
                ...
                if ( iCountComments > JsonRPC.LIMIT_INITIAL_COMMENTS )
                {
                    LibUI.setupTextView( state.getActivity(), commentsViewAll, AntiPatternsSystems.getFonts().TYPEFACE_BOLD, R.string.image_comments_view_all );
        ...
        **********************************************************************************************/
        private final void setupAreaLikesPreview( View ret, final LibState state )
        {
            ...
            AntiPatternsDebug.likesPreviews.out( "likesCount is [" + iCountComments + "]" );
            ...
            {
                //setup label
                LibUI.setupTextView( state.getActivity(), likesPreviewLabel, AntiPatternsSystems.getFonts().TYPEFACE_BOLD, R.string.image_likes );

                //browse initial likes
                for ( AntiPatternsDataLike like : iInitialLikes )
                {
                    AntiPatternsDebug.likesPreviews.out( " like [" + like.iPostedAt + "][" + like.iOwner.iUserName + "]" );
            ...
            if ( iCountLikes > JsonRPC.LIMIT_INITIAL_LIKES )
            {
                LibUI.setupTextView( state.getActivity(), likesViewAll, AntiPatternsSystems.getFonts().TYPEFACE_BOLD, R.string.image_likes_view_all );
        ...
        **********************************************************************************************/
        private final void setupTextLocation( View ret, Activity activity )
        {
            ...
            {
                LibUI.setupTextView( locationCaption, AntiPatternsSystems.getFonts().TYPEFACE_REGULAR, String.valueOf( iLocation.iName ) );
            }
            ...
            {
                LibUI.setupTextView( locationVicinity, AntiPatternsSystems.getFonts().TYPEFACE_REGULAR, String.valueOf( iLocation.iVicinity ) );
            }
            ...
            else
            {
                ...
                LibUI.setupTextView( locationDistance, AntiPatternsSystems.getFonts().TYPEFACE_REGULAR, distanceText );
            }
        }
        ...
        {
            AntiPatternsDebug.orderDetailedImageBitmaps.out( "Order detailed image for image from [" + iOwner.iUserName + "]" );
        ...
        public void assignLoadedImage( LibState state, ImageSize imageSize, final BitmapDrawable bd )
        {
            switch ( imageSize )
            {
                ...
                case ETiledImage:
                {
                    ...
                    AntiPatternsUI.setNewImageUIThreaded(state.getActivity(), bd, iImageView, R.drawable.de_mayflower_antipattern_loading_image);
        ...
        **********************************************************************************************/
        private void linkOrUnlinkUsername( final Activity activity, final TextView textView, final AntiPatternsDataUser user )
        {
                ...
                (
                    ...
                    new Runnable()
                    {
                        ...
                        public void run()
                        {
                            ...
                            AntiPatternsDataImage.this.unselectAllButtonsUIThreaded( activity );

                            //show the selected user profile
                            AntiPatternsFlowProfile.showUserProfile(activity, user);
                        }
                    }
                );
            }
            ...
            (
                ...
                new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        //show all image likes
                        AntiPatternsActionPush.EPushImageShowComments.run();
                    }
                }
            );
        }
            ...
            (
                ...
                new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        //show all image likes
                        AntiPatternsActionPush.EPushImageShowLikes.run();
                    }
                }
            );
        }
