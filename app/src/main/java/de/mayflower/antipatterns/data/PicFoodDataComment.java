 ...
 */
    ...
    **********************************************************************************************/
    public class PicFoodDataComment implements PicFoodData
    {
        ...
        **********************************************************************************************/
        public PicFoodDataComment( JSONObject json )
        {
        ...
        **********************************************************************************************/
        public static final PicFoodDataComment[] parse( JSONObject json )
        {
            JSONObject obj = LibJSON.getJSONObjectSecure( json, "comments" );
            JSONArray  arr = LibJSON.getJSONArraySecure(  obj,  "comments" );

            PicFoodDataComment[] ret = new PicFoodDataComment[ arr.length() ];
            for ( int i = 0; i < arr.length(); ++i )
            {
                ret[ i ] = new PicFoodDataComment( LibJSON.getJSONObjectSecure( arr, i ) );
            }
