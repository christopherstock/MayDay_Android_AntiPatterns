    ...
    *   @version    1.0
    *****************************************************************************/
    public class AntiPatternsGridViewFlow
    {
        /** The loading content item that is currently displayed on the bottom of the scrolling list. */
        protected AntiPatternsGridViewContentLoading iLastBottomLoadingItem  = null;
        ...
        *****************************************************************************/
        public AntiPatternsGridViewFlow(int aCount)
        {
            iCount   = aCount;
            iOffset  = 0;
        ...
        *****************************************************************************/
        ...
        )
        {
            ...
            AntiPatternsUI.pruneLoadingItems(iData);

            //create new adapter data
            for ( AntiPatternsData data : newData )
            {
                //create new item
            ...
            AntiPatternsDebug.limitOffset.out( "AFTER ordering comments\n" + toString() );
            ...
            if ( iOffset < iCount || showNextLoadingItem )
            {
                ...
                //add loading icon
                iLastBottomLoadingItem = new AntiPatternsGridViewContentLoading( state, true, true );
            ...
            AntiPatternsAdapterManager.getSingleton(state.getActivity(), gridView).changeDataUIThreaded( state, iData, actionOnBottomReach );
        }
