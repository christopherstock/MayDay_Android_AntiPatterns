    ...
    *   @version    1.0
    **********************************************************************************************/
    public class AntiPatternsFlowProfileFollow
    {
        /** The user that orderes followings or followers data. */
        public      static AntiPatternsDataUser lastUser                        = null;
        ...
        **********************************************************************************************/
        ...
        {
            AntiPatternsDebug.followship.out( AntiPatternsFlowProfile.class + "::orderNextFollowers() [" + AntiPatternsFlowProfile.profileDetailsEnteredVia + "]" );

            //order followers
            try
            {
                //output before ordering
                AntiPatternsDebug.limitOffset.out( "BEFORE ordering followers\n" + flow.toString() );

                //order detailed image data
                JSONObject  response    = AntiPatternsJsonRPCUser.getFollowers
                        (
                ...
                switch ( Integer.parseInt( status ) )
                {
                    case AntiPatternsJsonRPC.ERROR_CODE_OK:
                    {
                        ...
                        AntiPatternsDataUser[]   newUsers        = AntiPatternsDataUser.parse(response);
                        int                 count           = LibJSON.getJSONIntegerSecure( response, "count" );

                        AntiPatternsDebug.followUsers.out( "Parsed [" + newUsers.length + "] users from response, count is always 0: [" + count + "]" );
                        ...
                        (
                            ...
                            newUsers,
                            count,
                            AntiPatternsActionPush.EPushListEntryFollowDetails,
                            GridViews.EFollowDetails,
                            AntiPatternsActionUpdate.EUpdateFollowersDetailsNextOffset,
                            false
                        );
                        break;
                    }
                    ...
                    case AntiPatternsJsonRPC.ERROR_CODE_SESSION_EXPIRED:
                    {
                        ...
                        AntiPatternsIDM.sessionExpired(AntiPatternsState.EFollowDetails);
                        break;
                    }
                    ...
                    default:
                    {
                        ...
                        LibDialogProgress.dismissProgressDialogUIThreaded( AntiPatternsState.EFollowDetails.getActivity() );
            ...
            catch ( Throwable t )
            {
                ...
                else
                {
                    ...
                    AntiPatternsDebug.DEBUG_THROWABLE(t, "Throwable caught on showing followers", UncaughtException.ENo);
                }
            }
        }
        ...
        **********************************************************************************************/
        ...
        {
            AntiPatternsDebug.followship.out( AntiPatternsFlowProfile.class + "::orderNextFollowings() [" + AntiPatternsFlowProfile.profileDetailsEnteredVia + "]" );

            //order followings
            try
            {
                //output before ordering
                AntiPatternsDebug.limitOffset.out( "BEFORE ordering followings\n" + flow.toString());

                //order detailed image data
                JSONObject  response    = AntiPatternsJsonRPCUser.getFollowing
                        (
                                AntiPatternsState.EFollowDetails.getActivity(),
                                lastUser.iUserID,
                                flow.getOffset()
                ...
                switch ( Integer.parseInt( status ) )
                {
                    case AntiPatternsJsonRPC.ERROR_CODE_OK:
                    {
                        ...
                        (
                            ...
                            AntiPatternsActionPush.EPushListEntryFollowDetails,
                            GridViews.EFollowDetails,
                            AntiPatternsActionUpdate.EUpdateFollowingsDetailsNextOffset,
                            false
                        );
                        break;
                    }
            ...
            catch ( Throwable t )
            {
                ...
                else
                {
                    ...
                    //report this exception
                    AntiPatternsDebug.DEBUG_THROWABLE(t, "Throwable caught on showing followings", UncaughtException.ENo);
                }
            }
        }
        ...
        **********************************************************************************************/
        ...
        {
            flow = new AntiPatternsGridViewFlow( newCount );
        }
    }
