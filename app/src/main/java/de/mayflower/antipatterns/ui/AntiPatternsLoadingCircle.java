    ...
    *   @version    1.0
    *****************************************************************************/
    public abstract class AntiPatternsLoadingCircle
    {
        /*****************************************************************************
        ...
        *****************************************************************************/
        ...
        {
            AntiPatternsDebug.loadingCircles.out( "showAndStartLoadingCircleInOverlayUIThreaded()" );
        ...
        *****************************************************************************/
        ...
        {
            AntiPatternsDebug.loadingCircles.out( "removeLoadingCircleUIThreaded()" );
        ...
        *****************************************************************************/
        ...
        {
            AntiPatternsDebug.loadingCircles.out( "turnLoadingCircleToNoNetworkUIThreaded()" );
