    ...
    *   @version    1.0
    ************************************************************************/
    public class AntiPatternsGridViewContentLoading implements LibAdapterData
    {
        /************************************************************************
        ...
        ************************************************************************/
        public AntiPatternsGridViewContentLoading(LibState aActivity, boolean aShowTopSpacer, boolean aShowBottomSpacer)
        {
            //assign bg
        ...
        ************************************************************************/
        ...
        {
            //flush onClickAction
            iActionOnClick = AntiPatternsAction.ENone;
        ...
        public View createView( LibState state )
        {
          ...
          //PicFoodDebug.bugfix.out( " create view with [" + iLoadingState + "]" );
            switch ( iLoadingState )
            {
                case ELoadingCircle:
                {
                    AntiPatternsLoadingCircle.showAndStartLoadingCircle(state.getActivity(), loadingCircle);
                    break;
                }

                case ENoNetwork:
                {
                    AntiPatternsLoadingCircle.turnLoadingCircleToNoNetwork(loadingCircle, null);
                    break;
                }
            }
        ...
        public final void setupAndChangeToNoNetwork( final LibState state, final GridViews gridViewManager, final Runnable actionOnClick )
        {
            ...
            Runnable runnable = new Runnable()
            {
                ...
                public void run()
                {
                    ...
                    AntiPatternsAdapterManager.getSingleton(state.getActivity(), gridViewManager).invalidateGridViewUIThreaded( state );
