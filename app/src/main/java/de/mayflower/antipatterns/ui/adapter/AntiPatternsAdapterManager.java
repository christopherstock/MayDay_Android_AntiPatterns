    ...
    *   @version    1.0
    ************************************************************************/
    public class AntiPatternsAdapterManager
    {
        /************************************************************************
        ...
        ************************************************************************/
        public static enum GridViews
        {
            ...
            EExplore(           AntiPatternsState.EPivotalMenu,          GridView.AUTO_FIT,  R.dimen.content_distance_normal,    R.dimen.content_distance_normal,    R.dimen.content_distance_big        ),

            /** The GridView in state 'googlePlaces'. */
            EGooglePlaces(      AntiPatternsState.EGooglePlaces,         1,                  R.dimen.content_distance_normal,    R.dimen.content_distance_normal,    R.dimen.content_distance_normal     ),

            /** The GridView in state 'imageProperties'. */
            EImageProperties(   AntiPatternsState.EImageProperties,      1,                  R.dimen.content_distance_normal,    R.dimen.content_distance_normal,    R.dimen.content_distance_normal     ),

            /** The GridView in state 'followDetails'. */
            EFollowDetails(     AntiPatternsState.EFollowDetails,        1,                  R.dimen.content_distance_normal,    R.dimen.content_distance_normal,    R.dimen.content_distance_normal     ),

            /** The GridView in state 'findFriendsResults'. */
            EFindFriends(       AntiPatternsState.EFindFriendsResults,   1,                  R.dimen.content_distance_normal,    R.dimen.content_distance_normal,    R.dimen.content_distance_normal     ),
            ...
            ************************************************************************/
            protected AntiPatternsAdapterManager iManager                = null;
        ...
        ************************************************************************/
        public static final AntiPatternsAdapterManager getSingleton( Context context, GridViews gridView )
        {
            if ( gridView.iManager == null ) gridView.iManager = new AntiPatternsAdapterManager( context, gridView );
        ...
        ************************************************************************/
        private AntiPatternsAdapterManager(Context context, GridViews gridView)
        {
