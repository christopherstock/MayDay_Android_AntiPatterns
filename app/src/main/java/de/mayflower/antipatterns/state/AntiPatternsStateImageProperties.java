    ...
    *   @version    1.0
    **********************************************************************************************/
    public class AntiPatternsStateImageProperties extends Activity
    {
        /** The singleton instance of this state. */
        protected   static AntiPatternsStateImageProperties singleton                       = null;
        ...
        protected void onCreate( Bundle bundle )
        {
            ...
            //connect to GridView
            AntiPatternsAdapterManager.getSingleton(this, GridViews.EImageProperties).connect( container );
        ...
        protected void onStart()
        {
            ...
            if ( setupLikesNextOnStart )
            {
                ...
                //ditch the GridView
                AntiPatternsAdapterManager.getSingleton(this, GridViews.EImageProperties).clearData();

                //update the image's likes
                AntiPatternsActionUpdate.EUpdateImagePropertiesLikesClean.run();
            }
            else if ( setupCommentsNextOnStart )
            {
                ...
                AntiPatternsActionUpdate.EUpdateImagePropertiesCommentsClean.run();
            }
            else if ( setupFoodRatingsNextOnStart )
            {
                ...
                AntiPatternsActionUpdate.EUpdateImagePropertiesFoodRatingsClean.run();
            }
        }
        ...
        public boolean onKeyDown( int keyCode, KeyEvent event )
        {
            switch ( keyCode )
            {
                ...
                {
                    //leave this state
                    AntiPatternsActionState.ELeaveImageProperties.run();
