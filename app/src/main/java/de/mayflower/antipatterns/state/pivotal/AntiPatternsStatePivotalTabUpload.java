    ...
    *   @version    1.0
    **********************************************************************************************/
    public class AntiPatternsStatePivotalTabUpload extends Fragment
    {
        /** The singleton instance of this fragment. */
        public      static AntiPatternsStatePivotalTabUpload singleton                       = null;
        ...
        public View onCreateView( LayoutInflater li, ViewGroup vg, Bundle b )
        {
            ...
            //setup headline
            {
                ...
                LibUI.setupTextView( getActivity(), headline, AntiPatternsSystems.getFonts().TYPEFACE_REGULAR, R.string.state_upload_headline );
            }
            ...
            //setup buttons
            {
                ...
                LibUI.setupButton( getActivity(), iButtonUploadFromCamera, R.string.state_upload_from_camera, AntiPatternsSystems.getFonts().TYPEFACE_REGULAR, AntiPatternsActionPush.EPushUploadImageFromCamera );

                //button 'upload from gallery'
                iButtonUploadFromGallery    = (Button)uploadView.findViewById( R.id.upload_from_gallery );
                LibUI.setupButton( getActivity(), iButtonUploadFromGallery, R.string.state_upload_from_gallery, AntiPatternsSystems.getFonts().TYPEFACE_REGULAR, AntiPatternsActionPush.EPushUploadImageFromGallery );
            }
