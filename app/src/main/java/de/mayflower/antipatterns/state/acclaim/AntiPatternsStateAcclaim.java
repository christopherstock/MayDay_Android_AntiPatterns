    ...
    *   @version    1.0
    **********************************************************************************************/
    public class AntiPatternsStateAcclaim extends Activity implements OnPageChangeListener
    {
        /** The singleton instance of this state. */
        public      static AntiPatternsStateAcclaim singleton                   = null;
        ...
        private AntiPatternsStateAcclaimPage1 iPage1                      = null;
        /** The 2nd page of the ViewPager. */
        private AntiPatternsStateAcclaimPage2 iPage2                      = null;
        /** The 3rd page of the ViewPager. */
        private AntiPatternsStateAcclaimPage3 iPage3                      = null;
        /** The 4th page of the ViewPager. */
        private AntiPatternsStateAcclaimPage4 iPage4                      = null;
        /** The 5th page of the ViewPager. */
        private AntiPatternsStateAcclaimPage5 iPage5                      = null;
        ...
        protected void onCreate( Bundle savedInstanceState )
        {
            ...
            //try auto-login
            if ( Features.ENABLE_AUTO_LOGIN ) AntiPatternsFlowAutoLogin.checkAutoLogin(AntiPatternsState.EAcclaim);
        }
        ...
        **********************************************************************************************/
        private final void setupFooter()
        {
            ...
            LibUI.setupButton( this, iButtonRegister, R.string.state_acclaim_register, AntiPatternsSystems.getFonts().TYPEFACE_REGULAR, AntiPatternsActionState.EEnterRegister );

            //setup button 'login'
            iButtonLogin = (Button)findViewById( R.id.button_login );
            LibUI.setupButton( this, iButtonLogin, R.string.state_acclaim_login, AntiPatternsSystems.getFonts().TYPEFACE_REGULAR, AntiPatternsActionState.EEnterLogin );
        }
        ...
        **********************************************************************************************/
        private final void setupPages()
        {
            ...
            iPage1 = new AntiPatternsStateAcclaimPage1( this );
            iPage2 = new AntiPatternsStateAcclaimPage2( this );
            iPage3 = new AntiPatternsStateAcclaimPage3( this );
            iPage4 = new AntiPatternsStateAcclaimPage4( this );
            iPage5 = new AntiPatternsStateAcclaimPage5( this );
