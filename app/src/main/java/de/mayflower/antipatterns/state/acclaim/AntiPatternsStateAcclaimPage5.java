    ...
    *   @version    1.0
    **********************************************************************************************/
    public class AntiPatternsStateAcclaimPage5
    {
        ...
        **********************************************************************************************/
        public AntiPatternsStateAcclaimPage5(Context context)
        {
            ...
            //setup text
            LibUI.setupTextView( context, iAcclaimText, AntiPatternsSystems.getFonts().TYPEFACE_BOLD, R.string.state_acclaim_page5 );
        }
    }
