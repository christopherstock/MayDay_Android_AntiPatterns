    ...
    *   @version    1.0
    **********************************************************************************************/
    public class AntiPatternsStateAcclaimPage3
    {
        ...
        **********************************************************************************************/
        public AntiPatternsStateAcclaimPage3(Context context)
        {
            ...
            //setup text
            LibUI.setupTextView( context, iAcclaimText, AntiPatternsSystems.getFonts().TYPEFACE_BOLD, R.string.state_acclaim_page3 );
