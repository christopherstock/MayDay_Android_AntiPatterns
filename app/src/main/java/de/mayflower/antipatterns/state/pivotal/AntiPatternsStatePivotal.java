    ...
    *   @version    1.0
    **********************************************************************************************/
    public class AntiPatternsStatePivotal extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener
    {
        ...
        public      static AntiPatternsStatePivotal singleton                       = null;
        ...
        public void onStart()
        {
            ...
            {
                //unflag
                AntiPatternsSave.saveSetting(this, SaveKey.EStatePivotalShowSearchDialogNextOnStart, "false");

                //do it
                AntiPatternsActionDialog.EDialogSearchImages.run();
            }
        }
        ...
        **********************************************************************************************/
        ...
        {
            //init state activity
            iTabHost = (TabHost) AntiPatternsState.initStateActivity
            (
                    ...
                    AntiPatternsActionPush.EPushEclipseApp
            );
        ...
        **********************************************************************************************/
        private void addTab( TabHost tabHost, TabHost.TabSpec tabSpec )
        {
            ...
            (
                new TabHost.TabContentFactory()
                {
                    ...
                    {
                        //return empty view
                        View v = new View( AntiPatternsStatePivotal.this );
                        //v.setMinimumWidth(  0 );
        ...
        public boolean onKeyDown( int keyCode, KeyEvent event )
        {
            switch ( keyCode )
            {
                ...
                {
                    //eclipse the app
                    AntiPatternsActionPush.EPushEclipseApp.run();
