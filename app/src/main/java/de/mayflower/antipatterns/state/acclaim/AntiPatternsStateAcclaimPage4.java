    ...
    *   @version    1.0
    **********************************************************************************************/
    public class AntiPatternsStateAcclaimPage4
    {
        ...
        **********************************************************************************************/
        public AntiPatternsStateAcclaimPage4(Context context)
        {
            ...
            //setup text
            LibUI.setupTextView( context, iAcclaimText, AntiPatternsSystems.getFonts().TYPEFACE_BOLD, R.string.state_acclaim_page4 );
