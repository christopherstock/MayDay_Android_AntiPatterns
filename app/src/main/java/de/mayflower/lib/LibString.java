    ...
    ************************************************************************/
    public class LibString
    {
        ...
        **************************************************************************************************/
        ...
        /*************************************************************************************************
        *   A line-breaking-algorithm. Returns an array with strings that do not exceed the given width.
        *
        *   @param  aString         The string to break into lines.
        *   @param  aFont           The font for the string to measure.
        *   @param  aTargetWidth    The target width that the string-lines may not exceed.
        *   @return                 An array of strings. Each string will not exceed the given target width.
        **************************************************************************************************/
        public static final String[] breakLinesOptimized( String aString, LibFont aFont, int aTargetWidth )
        {
            //avoid exceptions
            if ( aString == null || aString.length() == 0 || aTargetWidth <= 0 ) return new String[] {};
            ...
            while ( true )
            {
                ...
                tooHighEndIndex = LibString.getNearestLinebreakIndexOptimized( aString, startIndex );
                ...
                while ( true )
                {
                    ...
                    if ( aFont.getStringWidth( aString.substring( startIndex, tooHighEndIndex ).trim() ) > aTargetWidth )
                    {
                    ...
                    else
                    {
                        ...
                        tooHighEndIndex = LibString.getNearestLinebreakIndexOptimized( aString, correctEndIndex );
                        if ( tooHighEndIndex == -1 )
                        {
                            tooHighEndIndex = aString.length();
                        }
