/*  $Id: LibLauncher.java 50541 2013-08-09 12:37:45Z schristopher $
 *  ==============================================================================================================
 */
    ...
    import  com.synapsy.android.lib.api.*;
    ...
    *   @see        "$URL: http://svn.synapsy.net/svn/Synapsy/PicFood/android/PicFood_1_0/trunk/src_lib/com/synapsy/android/lib/LibLauncher.java $"
    *********************************************************************************/
        ...
        *********************************************************************************/
        public static final void launchActivity( Activity activity, Class<?> activityClassToLaunch, int animIn, int animOut )
        {
            ...
            if ( animIn != -1 && animOut != -1 )
            {
                ...
                {
                    LibModernAPI5.overridePendingTransition( activity, animIn, animOut );
                }
            }
        }
